  ...
  return (
    <div className="h-[4rem] flex items-center justify-between select-none text-lg">
      ...
      <TransitionLink href="/" className="text-3xl md:pr-10 z-30 nav-magnetic">
        A<span className="text-lg">BIFY</span>
      </TransitionLink>
      ...
      {open && (
        <div
          ref={menuRef}
          className="absolute overflow-hidden top-0 right-0 w-screen h-screen bg-gray-300 dark:bg-gray-800 flex flex-col items-center justify-center gap-10 text-4xl font-medium z-20"
        >
